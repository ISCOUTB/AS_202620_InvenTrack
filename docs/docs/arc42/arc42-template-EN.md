...
- **Artefacto / Entorno:** módulo de registro de movimientos y stock; operación normal, horario comercial.
...
- **Medida de respuesta:** 0 casos de stock negativo y 0 casos de doble descuento del mismo movimiento en el 100 % de una prueba de concurrencia con 50 transacciones simultáneas sobre el mismo producto.
...
- **Artefacto / Entorno:** módulo de gestión de productos; operación normal.
- **Respuesta:** el sistema impide el borrado físico y solo permite desactivar (borrado lógico) el producto.
- **Medida de respuesta:** 100 % de los productos con movimientos asociados no pueden eliminarse físicamente; verificado con prueba automatizada.
...
- **Artefacto / Entorno:** sistema completo (backend); horario comercial pico.
- **Respuesta:** el sistema se recupera y el movimiento no confirmado no queda aplicado parcialmente.
- **Medida de respuesta:** disponibilidad ≥ 99 % mensual en horario comercial (8 a. m.–8 p. m.) y recuperación en ≤ 5 minutos tras una falla, medido con monitoreo de uptime.

### ESC-04 — Eficiencia de desempeño

- **Fuente:** empleado o dueño.
- **Estímulo:** consulta el inventario actual con filtros.
- **Artefacto / Entorno:** módulo de consulta de inventario; hora pico, hasta 20 usuarios concurrentes.
- **Respuesta:** el sistema retorna el listado solicitado.
- **Medida de respuesta:** ≤ 400 ms p95 con 20 usuarios concurrentes, medido con prueba de carga.

### ESC-05 — Usabilidad

- **Fuente:** empleado nuevo sin capacitación previa (viene de Excel o papel).
- **Estímulo:** debe registrar una entrada de mercancía por primera vez.
- **Artefacto / Entorno:** interfaz de registro de movimientos; primer uso, sin manual impreso.
- **Respuesta:** completa el registro correctamente guiándose solo por la interfaz.
- **Medida de respuesta:** ≥ 90 % de usuarios nuevos completan el registro sin asistencia en ≤ 3 minutos, medido en prueba de usabilidad con 5 usuarios representativos.
