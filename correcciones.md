...
| **HAL-07** | S6 | Violación de fronteras de dominio en verificación de movimientos (`in_memory_verificador_movimientos.py`). | Resuelto mediante la implementación de puertos de aplicación e inversión de dependencias cruzada (`ADR-0003`). Documentado en auditoría. | [`docs/adr/0003-inversion-dependencias-puertos-inter-modulo.md`](./docs/adr/0003-inversion-dependencias-puertos-inter-modulo.md), [`docs/auditoria-modularidad.md`](./docs/auditoria-modularidad.md) | **Corregido** |
